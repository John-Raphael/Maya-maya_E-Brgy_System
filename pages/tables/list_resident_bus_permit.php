        ...
        <div class="modal-body p-3">
          <form class="form-sample" action="../../php/config.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Business Name</label>
                  <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Location</label>
                  <div class="col-sm-12">
                    <input type="text" rows="4" class="form-control" name="location" id="location" required/>
                  </div>
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-success" value="submit" name="generate_bus_permit">Generate Certificate</button>
            </div>
          </form>
        </div>
      </div>
