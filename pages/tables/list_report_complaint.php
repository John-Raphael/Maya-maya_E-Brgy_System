                    ...
                    <div class="form-group row">
                      <div class="col-sm-8">
                        <div class="input-group d-flex flex-row-reverse">
                          <input class="form-control" type="text" id="searchKeyword" onkeyup="SearchData(0)" placeholder="Search Complaint ID or Complaint status">
                    ...
                    <table class="table table-stripped">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th width="20%"> Person to Complainant</th>
                          <th width="20%"> Person to Defendant</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content p-3">
        <div class="modal-header pl-3">
          <h5 class="modal-title pt-0 pb-0" id="exampleModalLabel">Complaint Report Details</h5>
        ...
        <div class="modal-body p-3">
          <form class="form-sample" action="../../php/config.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Complaint: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Details of Complaint: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
...
<div class="modal fade" id="AddModal" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content p-3">
        <div class="modal-header pl-3">
          <h5 class="modal-title pt-0 pb-0" id="exampleModalLabel">Complaint Report Form</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<br>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Details of Comlaint: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
