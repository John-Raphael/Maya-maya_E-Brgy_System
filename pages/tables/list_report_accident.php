                    ...
                    <div class="form-group row">
                      <div class="col-sm-8">
                        <div class="input-group d-flex flex-row-reverse">
                          <input class="form-control" type="text" id="searchKeyword" onkeyup="SearchData(0)" placeholder="Search Accident ID or Accident status">
                    ...
                    <table class="table table-stripped">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th width="20%"> Victims</th>
                          <th width="20%"> Accident's Location</th>
                          <th width="20%"> Reported By</th>
                          <th width="10s%" class="text-center"> Action</th>
                        </tr>
                      </thead>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content p-3">
        <div class="modal-header pl-3">
          <h5 class="modal-title pt-0 pb-0" id="exampleModalLabel">Accident Report Details</h5>
...
<div class="modal fade" id="AddModal" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content p-3">
        <div class="modal-header pl-3">
          <h5 class="modal-title pt-0 pb-0" id="exampleModalLabel">Accident Report Form</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body p-3">
          <form class="form-sample" action="../../php/config.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Location of Victim: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Reported by: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
                    <input class="form-control" list="submittedBy" name="submittedByName" id="submittedByName">
                    <datalist id="submittedBy">
            ...
            <!-- <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Name of Defendant: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Address of Defendant: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Details of Incident: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
