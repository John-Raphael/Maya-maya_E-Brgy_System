                      ...
                      <tbody id="dataTable">  <?php if ($resident_list->num_rows>0){
                          ...
                          <tr>
                              ...
                              <td class="text-center">
                                ...
                                <button type="submit" class="btn btn-info m-0 details" name="generate_brgy_clearance" value="<?=$rsd['Resident ID']?>">
                                  Generate
                                </button>
        ...
        <div class="modal-body p-3">
          <form class="form-sample" action="../../php/config.php" method="POST">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-success" value="submit" name="generate_ind_cert">Generate Certificate</button>
            </div>
          </form>
        </div>
      </div>
