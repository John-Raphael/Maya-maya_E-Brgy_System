        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <canvas id="blotterChart" width="400" height="400"></canvas>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    var data = {
        labels: ['Arrest Reports', 'Incidents', 'Crimes', 'Accidents', 'Others'],
        datasets: [{
            label: 'Blotter Statistics',
            data: [30, 20, 25, 15, 10], // Example data, you can replace with your actual data
            backgroundColor: [
                'rgba(255, 99, 132, 0.6)',
                'rgba(54, 162, 235, 0.6)',
                'rgba(255, 206, 86, 0.6)',
    ...
    var blotterChart = new Chart(ctx, {
        type: 'pie',
        data: data,
        options: options
    });
