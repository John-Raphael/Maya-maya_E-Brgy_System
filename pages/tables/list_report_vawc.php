        ...
        <div class="modal-body p-3">
          <form class="form-sample" action="../../php/config.php" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Suspect: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Relationship: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Case Details: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
...
<div class="modal fade" id="AddModal" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content p-3">
        <div class="modal-header pl-3">
          <h5 class="modal-title pt-0 pb-0" id="exampleModalLabel">VAWC Report Form</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body p-3">
          <form class="form-sample" action="../../php/config.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Case Name: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
...
<br>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-12 col-form-label pt-0 pb-0">Repoted By: <span class="text-danger">*</span></label>
                  <div class="col-sm-12">
