...
<head>
  ...
  <title>Mama-maya | Barangay Certification</title>
  <!-- base:css -->
  <?= $FormPlugins ?>
    ...
    <table class="table table-borderless">
      ...
      ?>
          ...
          <tr>
            ...
            <td colspan="3" class="text-center border-top border-right border-dark">
              <h2 id="body_title_1">B A R A N G A Y &nbsp&nbsp C E R T I F I C A T I ON</h2>
            </td>
          </tr>
          ...
          <tr>
            <td colspan="3" class="text-justify border-right border-dark">
              ...
              <p id="body_text_1">
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This is to certify that <?= $Title ?> <?= strtoupper($Name) ?>, legal of age a residence of <?= $Address ?>, Cavite City,
                is a duly registered member of this Barangay.
                <br><br>

                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This certification is being issued upon the request of the applicant
                namely: Mr./Mrs/Ms/ <?= $Name ?>
                <br><br>
      ...
      <tr>
        <td colspan="2" class="text-left border-right border-dark">
          ...
          <p id="body_sign_2">
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Applicant
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td class="text-right p-0 border-right border-bottom border-dark" colspan="2">
          <p id="body_sign_1">
            <?= strtoupper($OfclName) ?>
          </p>
          <p id="body_sign_2">
